...
export const ENDPOINTS = {
  ...
  VERIFICATION: {
    SEND_VERIFICATION: `${VERIFICATION_SERVICE_URL}/api/verification/sendverification`,
    VERIFY: `${VERIFICATION_SERVICE_URL}/api/verification/verify`,
  },
  ORDERS: {
  ...
  PROFILES: {
    ...
    GET: `${PROFILE_SERVICE_URL}/api/profiles`,
  ...
  EVENTS: {
    CATEGORIES: `${EVENT_SERVICE_URL}/api/events/categories`,
    CREATE: `${EVENT_SERVICE_URL}/api/events/create`,
    GET: `${EVENT_SERVICE_URL}/api/events`,
